    ...
    protected function saveRegisterForm()
    {
        ...
        return DB::transaction(function()
        {
            ...
            if($user->id){
                ...
                return redirect('register')->with('message', 'Register successfully, please check your e-mail.');
            }else{
                return redirect('register')->with('message', 'Register failed, please try again.');
            }
        });
    }
