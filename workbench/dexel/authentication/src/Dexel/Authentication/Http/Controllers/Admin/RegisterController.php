    ...
    */
    ...
    protected function saveRegisterForm()
    {
        ...
        return DB::transaction(function()
        {
            ...
            $validator = Admins::validation(array_merge($login_input,$profile_input));
            if ($validator->fails())
            {
            ...
            if($admin->id){
                ...
                return redirect('register/coach')->with('message', 'Register successfully, please check your e-mail.');
            }else{
                return redirect('register/coach')->with('message', 'Register failed, please try again.');
            }
        });
    }
