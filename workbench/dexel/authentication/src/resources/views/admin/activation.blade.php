...
<body id="app-layout" class="bg">
    ...
    <div class="row lrx-content">
	    ...
	    <div class="col-md-5 col-md-offset-5 lrx-content-login">
        <h3 class="col-md-offset-4">Account Activation</h3>              
        <div class="form-group formx-each">
                    <label for="password_confirmation" class="col-md-12 control-label">Thank you, your has been activated successfuly!,<a href={{url('/login/coach')}}>login</a></label>
                </div>
        </div>
    </div>
</div>
