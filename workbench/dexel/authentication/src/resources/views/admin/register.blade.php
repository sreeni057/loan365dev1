...
.reg-success{ color: #0a915d!important; }
                        ...
                        <form role="form" class="col-md-7 col-sm-10 col-xs-10"  method="post" enctype= multipart/form-data>
							...
							<div class="tab-content">
                                <div class="tab-pane active" role="tabpanel" id="step1">
                                    ...
                                    <label>Please enter your personal details in the following form.</label>
								...
								<div class="tab-pane" role="tabpanel" id="step2">
                                    ...
                                    <label>Tell us something about who you are and where you are from.</label>
                                    <label>*All fields are mandatory</label>
                                    <div class="form-horizontal dexel-coach-form">
                                ...
                                <div class="tab-pane" role="tabpanel" id="step3">
                                    <div class="container-fluid dexel-coach-expertPanel">
                                        <div class="row">
                                            ...
                                            <label>*Select one or more areas of expertise.</label>
                                            <div class="dexel-coach-expertise">
                                                @foreach($expertise as $expert)
                                                    <div class="col-md-3 col-sm-3 col-xs-3 expert-circle">
                                                        <input type='checkbox' name='expert_in[]' value="{{$expert->id}}" data="expert{{$expert->title}}" id="expert{{$expert->id}}" class="chk"/>
                                    ...
                                    <ul class="dexel-reg-btn">
                                        ...
                                        <li class="pull-right">
                                            <button type="button" class="btn btn-primary next-step" id="expertise_next">Next <i  style="font-size:12px" class="fa fa-arrow-right" aria-hidden="true"></i> </button>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tab-pane" role="tabpanel" id="complete">
                                    ...
                                    <label>Please confirm your details, you can click the back button in the form to edit incorrect values. </label>
                                    <div class="dexel-coach-finalize">
                                        <div id="page">
                                         <section class="container-fluid dexel-coach-DashboardContainer">
                                            <div class="row">
                                               <div class="col-md-10 col-sm-10 col-xs-12 dexel-coach-describeBanner">
                                                  <!--<div class="dexel-coach-describeHeader pull-left">
                                                        <img src="{{asset('assets/coach/images/baby.jpeg')}}" class="img-circle" alt="img">
                                                        <label class="pull-left" id="first_last_name">John Doe</label>

                                                  </div>-->
                                                  <div class="row dexel-coachPanel">
                                                     <div class="col-md-5 col-sm-8 col-xs-12 ">
                                                          <h1>Name</h1>
                                                           <h2 id="first_last_name_bold"></h2>
                                                     </div>
                                                     <div class="col-md-6 col-sm-8 col-xs-12 ">
                                                          <ul class="list-group ">
                                                            <li class="list-group-item text-left"><i class="fa fa-envelope-o" aria-hidden="true"></i><label id="mail_details"></label></li>
                                                            <li class="list-group-item text-left"><i class="fa fa-phone" aria-hidden="true"></i> <label id="contact_number_details"></label></li>
                                                            <li class="list-group-item text-left"><i class="fa fa-globe" aria-hidden="true"></i> <label id="contact_address_details"></label></li>
                                                          </ul>
                                                     </div>
                                         ...
                                         <div class="dexel-coach-maincontainer container-fluid">
                                            <div class="dexel-coach-description">
                                               <div class="row">
                                                  <div class="col-md-12 col-sm-10 col-xs-12">
                                                    <h1 class="text-left">Areas of Expertise</h1>
                                                    <h2 id="expert_in_details"></h2>
                                                    <h1 class="text-left">About</h1>
                                                     <p id="about_details"></p>
                                                  </div>
                                    ...
                                    <ul class="dexel-reg-btn">
                                        ...
                                        <li class="pull-right">
                                            <button type="submit" class="btn btn-primary next-step" id="register_id">Register <i  style="font-size:12px" class="fa fa-arrow-right" aria-hidden="true"></i> </button>
                                        </li>
                                    </ul>
