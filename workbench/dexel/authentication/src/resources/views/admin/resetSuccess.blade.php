...
.anchor-box-border{ margin-top: 30px; }
...
<body id="app-layout" class="bg">
    ...
    <div class="row lrx-content">
        ...
        <div class="form-group formx-each">
                    <label for="password_confirmation" class="col-md-12 control-label">Password has been updated successfuly! </label>

                </div>
                  <a class="anchor-box-border" href={{url('/login/coach')}}>login</a>
        </div>
    </div>
</div>
</body>
