...
<h3>or with Email</h3>
                              ...
                              <div class="tab-pane active" role="tabpanel" id="step1">
                                  ...
                                  <div class="form-horizontal dexel-coach-form">
                                      ...
                                      <div class="form-group lrx-radito-dark">
                                          ...
                                          <div class="col-sm-6">
                                            ...
                                            <?php $selected=''; if(old('gender') == $key) { $selected ='checked="checked"'; } ?>
                                                <span>{{$value}}</span><input type="radio" name="gender" placeholder="" value="{{$key}}" {{$selected}}>
                                            @endforeach
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-sm-7">
                                              <input type="text" class="form-control" id="dob" name="dob" placeholder="yyyy-mm-dd" value="{{old('dob')}}">
