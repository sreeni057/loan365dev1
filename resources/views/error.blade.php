...
<head>
    ...
    <link rel='stylesheet' id='style-static' href='{{URL::asset('css/be_style.css')}}'>
        ...
        <div class="container">
            <div class="column one">
                ...
                <div class="error_desk">
                    ...
                    <p>
                        <span class="check">Please check entered address and try again or </span><a class="button button_filled" href="{{url('/')}}">go to homepage</a>
                    </p>
                </div>
            </div>
        </div>
