    ...
    public function purchase($key)
    {
    	switch ($key) {
 			...
 			case '2': 	
 				...
 				return view('onboarding2',compact('key','fetchvalues'));
 				break;
 			...
 			case '3':
 				...
 				return view('onboarding3',compact('key','fetchvalues'));
 				break;
 			/*Applying Type*/
 			case '4':
 				$last_id        						= session::get('last_id');
 				...
 				return view('onboarding4',compact('key','fetchvalues'));
 				break;
 			...
 			case '5': 		
 				...
 				return view('onboarding5',compact('key','fetchvalues'));
 				break;
 			...
 			case '6':
 				...
 				return view('onboarding6',compact('key','fetchvalues'));
 				break;
 			...
 			case '7':
 				...
 				return view('onboarding7',compact('key','fetchvalues'));
 				break;
 			...
 			case '8':
 				...
 				return view('onboarding8',compact('key','fetchvalues'));
 				break;
 			case '9':
 					return redirect('/');
 					break;
